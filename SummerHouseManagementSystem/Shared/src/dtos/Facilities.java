...
//DW
    ...
    {
      // This method can be used to check if any facilities are available
    ...
    {
      if (b) {
        // If we want to set all facilities to available
        kitchen = true;
        internet = true;
        dishwasher = true;
        laundryMachine = true;
        ...
        // If we want to set all facilities to unavailable
        kitchen = false;
        internet = false;
        dishwasher = false;
