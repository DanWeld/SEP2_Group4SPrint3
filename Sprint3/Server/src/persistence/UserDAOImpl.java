...
public class UserDAOImpl implements UserDAO {
    ...
    public boolean saveUser(User user) {
        ...
        try (Connection connection = getConnection()) {
            ...
            PreparedStatement statement = connection.prepareStatement(
                    "INSERT INTO u(username, email, password, isAdmin) VALUES(?, ?, ?, ?)");
    ...
    public User getUserByEmail(String email) {
        ...
        try (Connection connection = getConnection()) {
            ...
            if (resultSet.next()) {
                ...
                System.out.println("User found: " + username + (isAdmin ? " (ADMIN)" : ""));
    ...
    public boolean deleteUser(String email) {
        try (Connection connection = getConnection()) {
            PreparedStatement statement = connection.prepareStatement("DELETE FROM u WHERE email = ?");
            statement.setString(1, email);
    ...
    public void update(User user) throws SQLException {
        try(Connection connection = getConnection()) {
            PreparedStatement statement = connection.prepareStatement("UPDATE u SET username = ?, password = ?, isAdmin = ? WHERE email = ?");
            statement.setString(1, user.getUsername());
            statement.setString(2, user.getPassword());
            statement.setBoolean(3, user.isAdmin());
            statement.setString(4, user.getEmail());
    ...
    public List<User> readByIsAdmin(boolean isAdmin) throws SQLException {
        try(Connection connection = getConnection()) {
            PreparedStatement statement = connection.prepareStatement("SELECT * FROM u WHERE isAdmin = ?");
