...
public class PropertyDAOImpl implements PropertyDAO
{
  ...
  @Override public void update(Property property) throws SQLException
  {
    try (Connection connection = getConnection())
    {
      ...
      statement.setBoolean(3, property.getFacilities().kitchen());
      statement.setBoolean(4, property.getFacilities().internet());
      statement.setBoolean(5, property.getFacilities().swimmingPool());
      statement.setBoolean(6, property.getFacilities().dishwasher());
      statement.setBoolean(7, property.getFacilities().laundryMachine());
